...
_NOZZLE_WALL_MM_S = 28
_NOZZLE_INFILL_MM_S = 50
_NOZZLE_CAP_MM_S = 22
_NOZZLE_DEFAULT_MM_S = 38

_RETRACT_LENGTH_MM = 1.2
_RETRACT_SPEED_MM_S = 50.0
_RETRACT_LIFT_MM = 0.6
...
_BRIDGE_FLOW_PCT = 92
_FIRST_LAYER_SPEED_MM_S = 18.0
_MAX_PRINT_SPEED_MM_S = 200.0
_FIRST_LAYER_ACCEL = 600
_DEFAULT_ACCEL = 1500
_FIRST_LAYER_HEIGHT_MM = 0.24
_FIRST_LAYER_TEMPERATURE_C = "210"

_CAP_EXTRUSION_LAYERS = 4
_FIRST_LAYER_MOTION_LAYERS = 4
_FLOW_RAMP = (100, 90, 94, 97, 100)

_SEAM_EXTRA_RETRACT_MM = 0.6
_SEAM_FLOW_PCT = 94
_SEAM_FAN_PCT = 80
_SEAM_JOIN_SPEED_MM_S = 15.0

_OVERHANG_FAN_PCT = 85
_TOP_FAN_PCT = 70
_IRONING_FAN_PCT = 30
_INTERFACE_FAN_PCT = 75
_SUPPORT_FAN_PCT = 75
